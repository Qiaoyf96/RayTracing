...
int main() {
    Camera<Sample, PathTracer> c(float3(50,52,295.6), float3(0,-0.042612,-1).norm(), 1024, 768, 3000);
    Scene scene;
    ...
    Sphere top(float3(50,-1e5+81.6,81.6), 1e5, color(), color(200, 200, 200), SPEC);
